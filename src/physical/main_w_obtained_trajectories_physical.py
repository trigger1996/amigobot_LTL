...
v_max_1_2 = 0.1425        # m/s
v_max_3   = 0.1425        # 0.245 m/s if craching        default: 0.205 m/s
...
def main():
    ...
    bot_2 = amigobot_TS(name='amigobot_2', yaml_file='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/robot_2.yaml',
                                                   map_file ='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/map.yaml',
                                                   time_to_wait = time_to_wait, u_dist_max = v_max_1_2)
    bot_3 = amigobot_TS(name='amigobot_3', yaml_file='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/robot_3_larger.yaml',   # robot_3_inv_larger.yaml   robot_3_inv.yaml
                                                   map_file ='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/map.yaml',
    ...
    bot_2 = amigobot_TS(name='amigobot_2', yaml_file='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/robot_2.yaml',
                                                   map_file ='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/map.yaml',
                                                   time_to_wait = time_to_wait, u_dist_max = v_max_1_2)
    bot_3 = amigobot_TS(name='amigobot_3', yaml_file='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/robot_3_inv_larger.yaml',   # robot_3_inv_larger.yaml   robot_3_inv.yaml
                                                   map_file ='/home/ghost/catkin_ws_ros/src/amigobot_LTL/model/physical/3_vehicles/map.yaml',
                                                   time_to_wait = time_to_wait, u_dist_max = v_max_3)
